...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a data-toggle="collapse" data-target=".shipping-calculator-form" href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>

	<section class="shipping-calculator-form collapse">
        ...
        */ ?>
		...
		<p><button type="submit" name="calc_shipping" value="1" class="shipping-update-button btn btn-default"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
